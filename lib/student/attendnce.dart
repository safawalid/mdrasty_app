...
class attendc extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Directionality(textDirection: TextDirection.rtl,
      child: MaterialApp(
        home: Scaffold(
          appBar:appbarchild(title: "الحظور"),
...
class MyCard extends StatelessWidget {
  ...
  void _saveDailyReport() async {
    ...
    String currentDateKey = 'daily_report_${DateTime.now().millisecondsSinceEpoch}'; // مفتاح فريد لكل تقرير يومي
